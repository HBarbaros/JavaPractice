...
public class GovernsCommunications {
    ...
    public static void main(String[] args) {
        ...
        result = // (statusCode == 200 || statusCode == 201 || statusCode == 201 || statusCode == 301 || statusCode == 303 || statusCode == 304 || statusCode == 307 || statusCode == 400 || statusCode == 401 || statusCode == 403 || statusCode == 404 || statusCode == 410 || statusCode == 500 || statusCode == 503)?
                (statusCode == 200)? "OK" :(statusCode == 201)? "Created" :(statusCode == 201)? "Accepted"
                ...
                :(statusCode == 500)? "Internal Server Error" :(statusCode == 503)? "Service Unavailable" : "Invalid Number";
...
/*
7. HTTP is the protocol that governs communications between web-servers
